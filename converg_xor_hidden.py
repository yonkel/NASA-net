...
for h in hidden_size:
    ...
    architecture = [p, h, 1]
    results_expnet = convergencia(architecture, ExpNet, [tahn, exp], learning_rate, max_epoch, repetitions, success_window, inputs_minus, labels_minus, False)
    ...
    results_mlp = convergencia(architecture, Perceptron, [sigmoid, sigmoid], learning_rate, max_epoch, repetitions, success_window, inputs_binary, labels_binary, False)
