...
quasi = Quasi()
hyper_params = {
    "activation_functions": [tahn, quasi, tahn],
    "learning_rate": 0.5,
    "weight_mean": 0.0,
    "weight_variance": 1
}
...
hidden_sizes = [[p, 5, 10, 1], [p, 5, 15, 1], [p, 10, 15, 1], [p, 15, 10, 1], [p, 15, 15, 1], [p, 15, 10, 1],
                [p, 15, 5, 1], [p, 10, 5, 1]]
...
save_results("Arch1", expname, plot_nets, plot_epcs)
