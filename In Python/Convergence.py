...
def convergence_mse(net_type, net_hyperparams, repetitions, max_epoch, success_window, inputs, labels, show=False,
                plt_name=""):
    threshold, label = get_threshold(labels)
    ...
    return {"nets": nets_successful, "epochs": [e[1] for e in epochs_to_success], "time": (end_time - start_time), "MSE": MSE_all, "good_outputs": good_outputs_all}
